        ...
        if choice.isdigit() and 1 <= int(choice) <= len(hot_packages):
            ...
            with loading_animation("Fetching package details..."):
                for package in packages:
                    ...
                    # DEBUG: Ambil product_type dari package_family
                    product_type = package_detail.get("package_family", {}).get("package_family_type", "PACKAGE")
                    print(f"DEBUG product_type untuk {package['family_name']}: {product_type}")
